...
static char KEY_SONY_IMAGE_STABILISER_VALUES[] = "pantech-is-values";
static char KEY_SONY_IMAGE_STABILISER[] = "pantech-is";
static char KEY_SONY_VIDEO_STABILISER[] = "pantech-vs";
static char KEY_SONY_VIDEO_STABILISER_VALUES[] = "pantech-vs-values";
static char KEY_SONY_VIDEO_HDR[] = "pantech-video-hdr";
static char KEY_SONY_VIDEO_HDR_VALUES[] = "pantech-video-hdr-values";
static char KEY_SONY_ISO_AVAIL_MODES[] = "pantech-iso-values";
static char KEY_SONY_ISO_MODE[] = "pantech-iso";
static char KEY_SONY_AE_MODE_VALUES[] = "pantech-ae-mode-values";
static char KEY_SONY_AE_MODE[] = "pantech-ae-mode";
...
static char *camera_fixup_getparams(int id, const char *settings)
{
    ...
    if (params.get(KEY_SONY_ISO_AVAIL_MODES)) {
        // fixup the iso mode list with those that are in the pantech list
    ...
    if (params.get(KEY_SONY_IMAGE_STABILISER)) {
        const char *pantech_is = params.get(KEY_SONY_IMAGE_STABILISER);
        if (strcmp(pantech_is, VALUE_SONY_STILL_HDR) == 0) {
    ...
    if (params.get(KEY_SONY_ISO_MODE)) {
        if (params.get(KEY_SONY_AE_MODE_VALUES)) {
            ...
            if (strcmp(aeMode, "auto") == 0 ) {
                ...
                params.set(KEY_ISO_MODE, "auto");
                const char *shutterSpeed = params.get("pantech-shutter-speed");
                if (shutterSpeed) {
...
static char *camera_fixup_setparams(int id, const char *settings)
{
    ...
    if (shutterSpeed) {
        if (strcmp(shutterSpeed, "auto") != 0) {
            params.set("pantech-shutter-speed", shutterSpeed);
